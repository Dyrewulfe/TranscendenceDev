...
void CMenuDisplay::SelectNextItem (void)

// SelectNextItem
//
// Select and highlight the next item in the menu
...
void CMenuDisplay::SelectPreviousItem(void)
...
bool CMenuDisplay::OnKeyDown(int iVirtKey, DWORD dwKeyData)
